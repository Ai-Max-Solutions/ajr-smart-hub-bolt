-- Temporarily disable problematic triggers and apply constraints
...
-- Apply constraint and data type cleanup without trigger interference
...
-- Re-create the triggers with updated functions
