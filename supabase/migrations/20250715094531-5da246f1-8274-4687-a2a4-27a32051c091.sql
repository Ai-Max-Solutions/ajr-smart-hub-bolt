-- Phase 1: Database Architecture for Task Plan / RAMS Register
...
-- Add work activities to contractor profiles
...
-- Add version tracking to RAMS documents
ALTER TABLE public.rams_documents 
ADD COLUMN document_version TEXT DEFAULT '1.0',
ADD COLUMN superseded_by UUID REFERENCES public.rams_documents(id),
