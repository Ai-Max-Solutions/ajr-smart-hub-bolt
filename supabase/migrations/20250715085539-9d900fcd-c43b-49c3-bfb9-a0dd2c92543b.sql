...
CREATE TABLE IF NOT EXISTS public.contractor_rams_signatures (
  ...
  valid_until TIMESTAMP WITH TIME ZONE, -- for time-limited signatures
...
(
  ...
  '2.1',
  ARRAY['testing', 'maintenance', 'fault-finding'],
  'very_high',
...
(
  ...
  '3.0',
  ARRAY['installations', 'first-fix', 'second-fix'],
  'high',
  'ELECTRICAL INSTALLATION SAFETY GUIDELINES
...
-- Add sample project RAMS requirements (you can customize these for specific projects)
-- This would typically be managed by admins through the interface