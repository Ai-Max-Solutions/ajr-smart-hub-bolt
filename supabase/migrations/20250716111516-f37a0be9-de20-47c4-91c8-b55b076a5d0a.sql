...
-- 3. Clean up duplicate emails by making them unique (fixed ambiguous column reference)
...
-- 4. Clean up duplicate drawing numbers (fixed ambiguous column reference)
...
-- 5. Clean up duplicate project UIDs (fixed ambiguous column reference)
