-- Phase 1: Fix Auth-Profile Creation (CRITICAL) - Fixed Version
-- Work with existing schema structure

-- First, check if profiles table exists and create with correct structure
...
-- Create or replace the handle_new_user function to work with actual Users table structure
...
BEGIN
    ...
    ELSE
        -- Insert new user into Users table (using actual column name 'id' instead of 'whalesync_postgres_id')
...
-- Phase 2: Create sync function for profiles to Users
