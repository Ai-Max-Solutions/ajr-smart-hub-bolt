-- Add comprehensive RAMS documents for all work types
INSERT INTO public.rams_documents (id, title, version, work_types, risk_level, content, minimum_read_time, is_active)
VALUES
  -- Electrical Work
  ('a1111111-aaaa-1111-aaaa-111111aaa1', 'Electrical Installation Safety Guide', 'v2.0', ARRAY['electrical-installation'], 'High', 
...
REMEMBER: If in doubt, do not proceed. Seek supervision.', 15, true),
  ...
  ('a1111111-aaaa-1111-aaaa-111111aaa2', 'Electrical Maintenance Safety Protocol', 'v1.8', ARRAY['electrical-maintenance'], 'High',
...
WARNING: Electrical work can be fatal. Follow all procedures.', 12, true),
  ...
  ('a1111111-aaaa-1111-aaaa-111111aaa3', 'Testing & Commissioning Safety Guide', 'v1.5', ARRAY['testing-commissioning'], 'Medium',
...
CAUTION: Ensure all safety systems are functional before handover.', 10, true),
  ...
  -- Fire Safety Work
  ('b2222222-bbbb-2222-bbbb-b2222222bb1', 'Sprinkler & Fire System Safety', 'v2.1', ARRAY['sprinkler-fire'], 'High',
...
CRITICAL: Fire safety systems protect lives. No shortcuts permitted.', 18, true),
  ...
  ('c3333333-cccc-3333-cccc-c3333333cc1', 'General Labour Safety Handbook', 'v1.9', ARRAY['general-labour'], 'Medium',
...
REMEMBER: Your safety is your responsibility.', 8, true),
  ...
  -- Plumbing Work
  ('d4444444-dddd-4444-dddd-d4444444dd1', 'Plumbing Installation Safety Guide', 'v1.7', ARRAY['plumbing'], 'Medium',
...
IMPORTANT: Protect public health through proper installation.', 12, true),
  ...
  -- HVAC Work
  ('e5555555-eeee-5555-eeee-e5555555ee1', 'Heating & Cooling System Safety', 'v2.0', ARRAY['heating-cooling'], 'High',
...
WARNING: Gas and electrical hazards present. Competent persons only.', 16, true),
  ...
  ('e5555555-eeee-5555-eeee-e5555555ee2', 'Ventilation & AC Safety Protocol', 'v1.6', ARRAY['ventilation-ac'], 'Medium',
...
CAUTION: Work at height and confined spaces present additional risks.', 11, true),
  ...
  -- Specialist Plumbing
  ('f6666666-ffff-6666-ffff-f6666666ff1', 'Pipe Fitting Safety Procedures', 'v1.4', ARRAY['pipe-fitting'], 'Medium',
...
SAFETY FIRST: Proper preparation prevents poor performance.', 9, true),
  ...
  ('g7777777-gggg-7777-gggg-g7777777gg1', 'Insulation Work Safety Guide', 'v1.3', ARRAY['insulation'], 'Low',
...
PROTECT YOURSELF: Insulation materials can cause irritation.', 7, true),
  ...
  -- Plant Room Work
  ('h8888888-hhhh-8888-hhhh-h8888888hh1', 'Tank & Plant Room Safety Procedures', 'v2.2', ARRAY['tank-plant-room'], 'High',
...
DANGER: Multiple hazards present. Follow all safety procedures.', 20, true),
  ...
  -- Engineering Work
  ('i9999999-iiii-9999-iiii-i9999999ii1', 'Mechanical Engineering Safety Protocol', 'v1.8', ARRAY['mechanical-engineering'], 'High',
