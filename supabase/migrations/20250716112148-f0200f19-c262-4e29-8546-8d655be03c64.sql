-- Constraint and Data Type Cleanup (Final attempt)
...
ALTER TABLE public."Users" ADD CONSTRAINT valid_phone_format 
CHECK (phone IS NULL OR (phone != '' AND length(phone) >= 10));

ALTER TABLE public."Users" ADD CONSTRAINT valid_skills_array 
