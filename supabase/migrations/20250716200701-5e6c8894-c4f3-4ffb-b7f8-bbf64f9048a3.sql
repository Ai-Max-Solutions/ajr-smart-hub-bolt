...
SELECT 
    ...
    '2024-07-08'::date,
    CASE 
        WHEN (u.id::text || p.id::text)::uuid < '50000000-0000-0000-0000-000000000000' THEN 'Approved'::timesheet_status_enum
        WHEN (u.id::text || p.id::text)::uuid < 'a0000000-0000-0000-0000-000000000000' THEN 'Submitted'::timesheet_status_enum
...
-- Create sample timesheet entries (limited to avoid complexity)
INSERT INTO public.timesheet_entries (timesheet_id, plot_id, work_category_id, hours, notes)
SELECT 
    t.id,
    pl.id,
    wc.id,
    ROUND((8 * RANDOM() + 1)::numeric, 2),
    'Work completed as scheduled'
FROM public.timesheets t
JOIN public.plots pl ON pl.project_id = t.project_id
