-- AJ Ryan SmartWork Hub - Demo Data Seeding (Role-Fixed)
-- This migration creates realistic demo data with correct role mappings

-- First, let's create the missing tables that don't exist yet
...
-- Now create project team assignments using the CORRECT role mapping
-- project_team expects: 'PM', 'Supervisor', 'Engineer', 'Worker', 'Admin'
-- Users table has: 'Project Manager', 'Supervisor', 'Operative', 'Admin', 'DPO'
WITH projects AS (
