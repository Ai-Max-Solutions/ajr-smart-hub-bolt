-- Phase 1: Data Cleanup and Constraint Improvements
...
SET projectuid = projectuid || '-v' || duplicate_projects.rn::text
...
-- Drawing numbers should be unique within their context
ALTER TABLE public."Drawings" 
ADD CONSTRAINT unique_drawing_number UNIQUE (drawingnumber);

-- Project UIDs should be unique
ALTER TABLE public."Projects" 
ADD CONSTRAINT unique_project_uid UNIQUE (projectuid);
...
-- Preferred work days validation - must be valid day names
ALTER TABLE public."Users" 
