...
export function ProjectsDashboard() {
  ...
  const fetchProjects = async () => {
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to load projects. Check your plumbing connections!",
        variant: "destructive"
      });
    }
  };
  ...
  const fetchStats = async () => {
    try {
      ...
      setStats({
        ...
        activeUnits: plotCount || 0,
        pendingTasks: (totalTasks || 0) - (completedTasks || 0),
        testCoverage: totalTasks ? Math.round(((testedTasks || 0) / totalTasks) * 100) : 0,
