    ...
    Tables: {
      ...
      ai_compliance_predictions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ai_compliance_predictions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "user_view"
      ...
      contractor_profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "contractor_profiles_auth_user_id_fkey"
      ...
      cscs_card_analysis: {
        ...
        Relationships: [
          {
            foreignKeyName: "cscs_card_analysis_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "user_view"
            referencedColumns: ["auth_id"]
      ...
      voice_interaction_logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "voice_interaction_logs_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "user_view"
            referencedColumns: ["auth_id"]
